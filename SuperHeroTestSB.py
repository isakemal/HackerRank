...
if __name__ == '__main__':
    #with open(os.path.join("SuperHeroFiles", "SuperHeroIndividualInput39.txt")) as f:
    #with open(os.path.join("SuperHeroFiles", "SuperHeroIndividualInput60.txt")) as f:
    #with open(os.path.join("SuperHeroFiles", "SuperHeroIndividualInput67.txt")) as f:
    #with open(os.path.join("SuperHeroFiles", "SuperHeroIndividualInput40.txt")) as f:
    with open(os.path.join("SuperHeroFiles", "SuperHeroIndividualInput38.txt")) as f:
